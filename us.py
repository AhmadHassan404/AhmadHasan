...
→   Owner      :  AHMAD HASSAN
→   Facebook   :  AHMAD 
→   Github     :  AHMAD_KHAN404 
→   Tool Type  :  FREE
\x1b[1;97m→   Version    :  TRAILER 
\33[1;37m----------------------------------------------""")
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=0d12ZOd7p3IBV6fyrBXv8Iz-; sb=0d12ZC7cIwf5BvI3TnP3sHoo; dpr=2; locale=en_US; vpd=v1%3B680x360x2; wl_cbv=v2%3Bclient_version%3A2266%3Btimestamp%3A1685682982; dnonce=AWnuwZdssKvB5HYwZRuHee4bi7Pzix0APrvZBLW4TItVsGL_D4mxAv3S1UgiW8808BGr-fjBl5fRwP-D75kk7lgh; m_pixel_ratio=2; wd=360x680; fr=0Io798eG8abfgM4v4.AWWI13dc6LsHWZH5BQptT_UWTSw.Bkdt4r.fD.AAA.0.0.BkeZJc.AWUPbYg_UXg',
